...
import gov.doc.isu.lec.util.AppConstants;
import gov.doc.isu.lec.util.LogProcessorUtil;
import gov.doc.lec.business.LoggedExceptionController;
...
public class Application extends AbstractApplication implements IEmailable{
    ...
    private static final String MY_CLASS_NAME = "gov.doc.isu.lec.application.Application";
    ...
    protected CustomProperties getAdditionalLoggingProperties() {
        ...
        logProps.put("gov.doc.isu.lec.application.level", "INFO");
        logProps.put("gov.doc.isu.lec.file.level", "INFO");
        logProps.put("gov.doc.isu.lec.model.level", "INFO");
        logProps.put("gov.doc.isu.lec.util.level", "INFO");
        logProps.put("gov.doc.lep.business.level", "INFO");
        return logProps;
